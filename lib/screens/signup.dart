...
class Statesign extends State<Signup>{
  ...
  changevaluetype(ind){
    //subtypelist.clear();
    setState(() {
      print(subtypevalues[ind][(ind + 1).toString()]);
            ...
            offset: Offset(0.5, 0.5), // shadow direction: bottom right
              ...
              child:  SingleChildScrollView(
                child: Column(children: [
                  ...
                  Directionality(textDirection: TextDirection.rtl, child:!type?Container(): Container(margin: EdgeInsets.only(top: MediaQuery.of(context).size.height * 0.02),
                    decoration: Decorationezz.boxdeco, width: MediaQuery.of(context).size.width*0.9,padding: EdgeInsets.all(MediaQuery.of(context).size.width*0.01),child: TextFormField(keyboardType: TextInputType.number,controller: id,validator: signuplogic.validatename ,style: TextStyle(fontSize: MediaQuery.of(context).size.height*0.017),decoration: InputDecoration(hintText: "الهوية الوطنية",border: InputBorder.none),),)),
                  ...
                  Container(
                    child:!type?Container(): Container(width: MediaQuery.of(context).size.width*0.9,margin: EdgeInsets.only(top: MediaQuery.of(context).size.height * 0.02),
                      decoration: Decorationezz.boxdeco,child: Column(children: [
                        ...
                        ,child: Container(margin: EdgeInsets.only(top: 10,bottom: 10),child: Center(child:photo == null? Image(image: AssetImage("images/emptyphoto.png"),):Image(image: FileImage(photo)) ,),)),
